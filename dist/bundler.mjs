...
import {io as $gCcbY$io} from "socket.io-client";
import {decode as $gCcbY$decode, encode as $gCcbY$encode, Encoder as $gCcbY$Encoder, decodeMultiStream as $gCcbY$decodeMultiStream} from "@msgpack/msgpack";
    ...
    async start(id, token) {
        return new Promise((resolve, reject)=>{
            ...
            if (this._clientType === "websocket") {
                ...
                this._websocket = new WebSocket(wsUrl + "&version=" + (0, $f5f881ec4575f1fc$exports.version));
            } else this._socketio = (0, $gCcbY$io)(this._baseSocketioUrl + "/peerjs", {
                query: {
                    ...this._baseSocketioQueryParams,
                    token: token,
                    version: $f5f881ec4575f1fc$exports.version
                }
            });
            ...
            if (this._clientType === "websocket") {
                ...
                this._socketio.on("message", (data)=>{
                    try {
                        ...
                        (0, $257947e92926277a$export$2e2bcd8739ae039).log("Invalid server message", data);
                        return;
                    }
                    this.emit((0, $78455e22dea96b8c$export$3b5c4a4b6354f023).Message, data);
                });
                this._socketio.on("disconnect", (reason)=>{
                    if (this._disconnected) return;
                    (0, $257947e92926277a$export$2e2bcd8739ae039).log("Socket closed.", reason);
                    this._cleanup();
                    this._disconnected = true;
                    this.emit((0, $78455e22dea96b8c$export$3b5c4a4b6354f023).Disconnected);
                    if (!isResolved) {
...
class $6366c4ca161bc297$export$d365f7ad9d7df9c9 extends (0, $5045192fc6d387ba$export$23a2a68283c24d80) {
    ...
    constructor(peerId, provider, options){
        super(peerId, provider, options);
        this.messageSize = new (0, $fcbcc7538a6776d5$export$f1c5f4c9cb95390b)().chunkedMTU;
    ...
    parseMaximumSize(description) {
        ...
        (0, $257947e92926277a$export$2e2bcd8739ae039).log("peerDescription\n" + remoteLines);
        ...
        if (remoteMaximumSize === 0) (0, $257947e92926277a$export$2e2bcd8739ae039).log("SENDER: No max message size session description");
        // 16 kb should be supported on all clients so we can use it
        // even if no max message is set
        return Math.max(remoteMaximumSize, new (0, $fcbcc7538a6776d5$export$f1c5f4c9cb95390b)().chunkedMTU);
    }
    async updateMaximumMessageSize() {
        ...
        (0, $257947e92926277a$export$2e2bcd8739ae039).log(`SENDER: Updated max message size: ${this.messageSize} Local: ${localMaximumSize} Remote: ${remoteMaximumSize}`);
    }
    /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(dc) {
        this.dataChannel = dc;
...
class $9fcfddb3ae148f88$export$f0a5a64d5bb37108 extends (0, $a229bedbcaa6ca23$export$ff7c9d4c11d94e8b) {
    ...
    _handleDataMessage({ data: data }) {
        ...
        if (this.options.msgpackType === "peerjs") deserializedData = (0, $gCcbY$unpack)(data);
        else deserializedData = (0, $gCcbY$decode)(data);
    ...
    _handleChunk(data) {
        (0, $257947e92926277a$export$2e2bcd8739ae039).chunk(data);
    ...
    _send(data, chunked) {
        let blob;
        if (this.options.msgpackType === "peerjs") blob = (0, $gCcbY$pack)(data);
        else blob = (0, $gCcbY$encode)(data);
    ...
    _sendChunks(blob) {
        ...
        (0, $257947e92926277a$export$2e2bcd8739ae039).chunk(`DC#${this.connectionId} Try to send ${blobs.length} chunks...`);
        for (const blob of blobs){
            (0, $257947e92926277a$export$2e2bcd8739ae039).chunk(`chunk data ${blob.toString()}`);
            this.send(blob, true);
        }
    }
}
...
class $416260bce337df90$export$ecd1fc136c422448 extends (0, $23779d1881157a18$export$6a678e589c8a4542) {
    ...
    constructor(id, options){
        ...
        if (userId) this._initialize(userId).catch((error)=>this._abort((0, $78455e22dea96b8c$export$9547aaa2e39030ff).ServerError, error));
        else if (this.options.clientType === "websocket") this._api.retrieveId().then((id)=>this._initialize(id)).catch((error)=>this._abort((0, $78455e22dea96b8c$export$9547aaa2e39030ff).ServerError, error));
        else this._initialize().catch((error)=>this._abort((0, $78455e22dea96b8c$export$9547aaa2e39030ff).ServerError, error));
    }
    _createServerConnection() {
        const socket = new (0, $8f5bfa60836d261d$export$4798917dbf149b79)(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.clientType, this._options.pingInterval);
